...
namespace Apresentacao
{
    public partial class frmClienteCadastro : Form
    {
        ...
        //instancias das classes e objetos necessarios do projeto
        ...
        public frmClienteCadastro(string tipoAcao, Cliente cliente/*, Telefone telefone, TipoTelefone tipoTelefone*/)
        {
            ...
            {
                //pega os codigos correspondentes ao colunas que pertencem a cada classe no datagridview
            ...
            else
            {
                ...
                txtCodTel.Text = telefone.CodTelefone.ToString();
            ...
            else
            {
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        MessageBox.Show("Registro alterado com sucesso!" + retorno4 + retorno5 + retorno6);
                    }
                    catch
                    {

                        MessageBox.Show("Erro ao alterar!" + retorno4 + retorno5 + retorno6);
                    }
                }
