...
{
    public partial class AlterarProdutoOrcamento : Form
    {
        public AlterarProdutoOrcamento()
        {
            InitializeComponent();
        }
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                var form = Application.OpenForms["AlterarOrcamento"] as AlterarOrcamento;
        ...
        private void AlterarProdutoOrcamento_Load(object sender, EventArgs e)
        {
            string Config = "server=127.0.0.1;userid=root;database=bd_commanager";
