...
public class Jogo extends JFrame {  
   ...
   /* 
    * tempo de temporização da mensagem 
    */  
   private final int TEMPO = 1;  
   //num é um número aletório entre um e 3  
   int num;     
   //As três imagens     
   ImageIcon copo = new ImageIcon("src/aula/imagens/copo.gif"); //Copo abaixado  
   ImageIcon copoe = new ImageIcon("src/aula/imagens/copoE.gif"); //Copo levantado sem o gato  
   ImageIcon copoc = new ImageIcon("src/aula/imagens/copoC.gif");//Copo levantado com o gato  
   ImageIcon copo2 = new ImageIcon("src/aula/imagens/copo.gif"); //Copo abaixado  
   JButton btn1;  
   JButton btn2;  
   JButton btn3;  
   JButton btn4;
   ...
   public Jogo() {  
      ...
      JLabel lblTitulo = new JLabel("Encontre o Lindo!");  
      ...
      btn4 = new JButton("Copo 4");  
      btn4.setBackground(getContentPane().getBackground());  
      btn4.addActionListener(new Action_button4());  
      btn4.setBounds(492, 200, 96, 200);  
      add(btn4);  
   ...
   public class Action_button4 implements ActionListener {  
	      public void actionPerformed(ActionEvent e) {  
	         if (num == 4) {  
	            Temporizador.exibirMensagem(TEMPO, "Você Acertou",  
	                  JOptionPane.INFORMATION_MESSAGE);  
