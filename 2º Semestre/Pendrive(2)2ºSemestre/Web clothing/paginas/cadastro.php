	...
	<header>&raquo; Cadastre-se grátis.</header>
        <table>
            ...
            <tr>
                ...
                <td><input type="tel" name="txtTelefone" placeholder="(xx)xxxxx-xxxx" required class="inputFormulario" maxlength="11"/></td>
            </tr>        <tr>
            ...
            <tr>
                ...
                <td><input type="text" name="txtCPF" placeholder="000.000.000-00" required class="inputFormulario" maxlength="11"/></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" name="txtCep" placeholder="00000-000" required class="inputFormulario" maxlength="8"/></td>
            </tr>
